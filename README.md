...
4. [Общие шаблоны слоёв](#общие-шаблоны-слоёв)
5. [Что вы увидите на экране](#что-вы-увидите-на-экране)
6. [Как это устроено: архитектура](#как-это-устроено-архитектура)
7. [Как загружаются данные](#как-загружаются-данные)
8. [Кэш территорий](#кэш-территорий)
9. [Фильтр детализации](#фильтр-детализации)
10. [Слои и порядок отображения](#слои-и-порядок-отображения)
11. [Сетка H3](#сетка-h3)
12. [Поиск](#поиск)
13. [Требования к таблице](#требования-к-таблице)
14. [Сборка из исходников](#сборка-из-исходников)
15. [Тестовый стенд и автотесты](#тестовый-стенд-и-автотесты)
